...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "mx-auto hidden h-16 items-end gap-4 rounded-2xl bg-neutral-800 px-4 pb-3 md:flex border border-white/25",
        className,
      )}
    >
      {items.map((item) => (
  ...
  return (
    <a href={href}>
      <motion.div
        ...
        className="relative flex aspect-square items-center justify-center rounded-full bg-neutral-900 border-2 border-white"
      >
        <AnimatePresence>
          {hovered && (
            <motion.div
